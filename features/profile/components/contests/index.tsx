...
type Data = AuditorContestsResult;
      ...
      return (
        <TableCell width={width}>
          <Stack direction="row" spacing={1} alignItems="center">
            <span>
              {value.user ?? 'N/A'} / {value.total ?? 'N/A'}
            </span>
            {value.user && value.user <= 3 && <MedalIcon place={value.user} />}
          </Stack>
        </TableCell>
      );
    case 'findings':
...
export const ContestTable = ({ rows, isLoading }: ContestTableProps) => {
